...
manifest.update(sha256=sha(p),bytes=p.stat().st_size,manifest_sha256=sha(root/'lsb-fex.json'),url='https://github.com/Russianranger/lsb-android/releases/download/runtime-fex-v1/runtime-fex-arm64.tar.gz')
