...
final class ClientRuntime {
    ...
    private void download(File target,SafeZip.Progress progress)throws Exception {
        ...
        for(int redirects=0;redirects<8;redirects++){
            ...
            HttpURLConnection c=(HttpURLConnection)address.openConnection();c.setInstanceFollowRedirects(false);c.setConnectTimeout(20000);c.setReadTimeout(30000);c.setRequestProperty("User-Agent","LSB-Android/0.5.10");
            try{
