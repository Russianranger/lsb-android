...
final class SourceImport {
    ...
    static HttpURLConnection connect(String address) throws IOException {
        for (int count = 0; count < 6; count++) {
            ...
            HttpURLConnection c = (HttpURLConnection)url.openConnection(); c.setConnectTimeout(15000); c.setReadTimeout(30000); c.setInstanceFollowRedirects(false); c.setRequestProperty("User-Agent", "LSB-Android/0.1.3");
    ...
    static String stage(File home, InputStream in, String origin, SafeZip.Progress progress) throws Exception {
        ...
        try {
            ...
            String report = "Source: " + origin + "\nStatus: source staged; compiler and server runtime are not installed in 0.1.3.\n";
