...
Current development: **0.5.33 repairs localhost resolution for MariaDB initialization in the server runtime.** The client now renders correctly and the user accepted Trial F's checked runtime syscall filtering as a default in 0.5.28. Preserve prepared client `30251204_1`, original xiloader, the accepted FEX v3/Turnip 26/DXVK 2.7.1/two-worker profile, and the Box64 fallback. See [handoff](docs/HANDOFF.md).
